...
excerpt: >-
  I like new things. AWS has an endless amount of cool things in its services,
  but site hosting in buckets just doesn't have that "shiny" new feel. My
  CI/CD...
date: '2019-12-10'
category: Cloud
tags:
...
Peeking at Netlify's settings, I saw it had some Git integrations enabled by default. I immediately enabled them all and created a PR to test. Deploy comments and checks! Ooh ahh CI/CD:

![](/images/articles/netlifyPR.png)
...
I started with [Netlify DNS](https://www.netlify.com/blog/2017/12/19/an-easier-way-to-manage-domains-and-dns-on-netlify/) (still in beta), so there were really only a few steps to get the site up at a custom domain:
...
![](/images/articles/netlifySiteDomain.png)

...
excerpt: >-
  On a snowy day a while back I threw together a project to explore serverless
  functions. For whatever reason I decided the world needed a Twitter garlic
  'bot'....
date: '2022-01-26'
category: Cloud
tags:
...
![CloudWatch schedule expression cron](/images/articles/lambda_schedule_cron.png)
...
![Cloudwatch and Lambda API sequence diagram](/images/articles/cloudwatch_lambda_sequence.png)

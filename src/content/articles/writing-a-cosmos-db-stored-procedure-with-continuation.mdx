...
excerpt: >-
  We will explore one of the essential features of Cosmos DB - pagination and
  continuation tokens. Below is a brief look at a robust & practical
  implementation...
date: '2023-03-11'
category: Cloud
tags:
...
Within a partition the stored procedure will be doing the equivalent SQL query (with pagination):

...
I've been a VSCode user for years. I even [wrote about my setup](/articles/my-custom-operator-mono-vscode-setup) — Operator Mono, sidebar on the right, the whole thing. But Zed has been pulling me in. 
It's native, it's genuinely fast in a way that Electron apps just aren't, and the configuration surface is surprisingly deep. It's also completely open - if you want a feature, just hack away.
...
<div style={{ textAlign: "center", fontWeight: 800, fontStyle: "italic" }}>
...
For JSON, CSS, SCSS, HTML, and Markdown, Prettier is configured as an external formatter since these don't need ESLint. The per-language `tab_size: 2` override is important, as the JS/TS ecosystem has standardized on 2.

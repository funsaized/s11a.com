...
excerpt: >-
  I've been eyeing styled-components for a while now, so I decided to throw
  together a clone of the Discord login form to get a feel for developing with
  the...
date: '2020-11-22'
category: Frontend
tags:
...
I've been eyeing [styled-components](https://styled-components.com/) for a while now, so I decided to throw together a clone of the Discord login form to get a feel for developing with the library. Here's my current progress - it's responsive, but missing some key elements like the cool SVG animation of the background:

![](/images/articles/discordClone.png)

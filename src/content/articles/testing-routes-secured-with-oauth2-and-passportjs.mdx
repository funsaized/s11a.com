...
excerpt: >-
  I recently started poking at the developer experience of the Node.js world. As
  a Java dev by day, I wanted to learn the JS community patterns on a lower...
date: '2025-04-17'
category: Backend
tags:
  - JavaScript
...
Therefore, the approach here outlines the path I took: a Passport.js strategy to functionally test protected routes without making HTTP requests to the authentication provider.
...
![Oauth 2.0 authorization code flow](/images/articles/oauth2-authorization-code-flow.png)
...
That's really all there is to it. You can now write tests for your protected routes. Endpoints will still be protected by the passport middleware, but the strategy will be mocked, making authenticating before each test case a simple procedure.

...
excerpt: >-
  When developing a production ready data pipeline, there are a number of
  aspects to consider aside from simply developing functional code. For example,
  a...
date: '2018-01-03'
category: Backend
tags:
...
To run this locally, we simply call our wrapper task using the syntax outlined in Luigi’s docs and pass in our parameters. The final flag tells Luigi not to connect to a scheduled server:

...
excerpt: >-
  CSS still scares me. Even after using it every day for years I'm always
  fascinated by the number of ways that exist to do something and the new
  features that...
date: '2020-03-24'
category: Frontend
tags:
...
CSS still scares me. Even after using it every day for years I'm always fascinated by the number of ways that exist to do something and the new features that come out each year.
...
<iframe
  ...
  src="https://codepen.io/funsaized/embed/GRpLMWp?height=265&theme-id=dark&default-tab=result"
  frameBorder="no"
  allowFullScreen={true}
/>

The styles on the class `buttonList` demonstrate the result:
...
<iframe
  ...
  style={{width: "100%"}}
  scrolling="no"
  title="Supreme store item"
  src="https://codepen.io/funsaized/embed/NWGPaZX?height=900&theme-id=dark&default-tab=result"
  frameBorder="no"
  allowFullScreen={true}
/>

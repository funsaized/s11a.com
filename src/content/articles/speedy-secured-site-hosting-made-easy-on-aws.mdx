...
excerpt: >-
  I recently migrated this site's hosting to AWS and was pleasantly surprised to
  find that you can host a static, secure website with a custom domain on the
  AWS...
date: '2019-11-25'
category: Cloud
tags:
...
![](/images/articles/s3StaticHosting.png)
...
![Setup of redirect bucket via HTTP](/images/articles/s3Redirect.png)

        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="bg-card border border-border rounded-lg shadow-sm">
            <div className="p-8">
              ...
              {/* Note Content */}
              <div className="prose max-w-none dark:prose-invert prose-headings:scroll-mt-8 prose-pre:overflow-x-auto prose-code:before:content-none prose-code:after:content-none prose-img:rounded-lg prose-img:shadow-md prose-img:mx-auto prose-a:break-words overflow-hidden">

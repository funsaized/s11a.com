...
toc:
  ...
  - title: The scenario
    items:
      - title: The datamodel
  - title: Setting up the project & reading data
    items:
      - title: Adding POJOs for the domain objects
      - title: Reading and parsing XML records in batch
  - title: Connecting & writing to MySQL
  - title: An example ItemProcessor
  - title: Executing parallel writes
  - title: Summary
---

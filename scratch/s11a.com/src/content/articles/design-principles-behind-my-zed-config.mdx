...
toc:
  - title: AI as a co-pilot
    items:
      - title: MCP Context Servers
  - title: Typography is interface design
  - title: Two editors for the price of one
    items:
      - title: Italic overrides everywhere
  - title: Information density without noise
    items:
      - title: Minimap always on
      - title: Wrap guides at 80, 100, and 120
      - title: Active pane modifiers
      - title: Project panel on the right
      - title: Git inline blame
  - title: Let the machines handle formatting
    items:
      - title: TypeScript LSP
  - title: The small things that add up
  - title: The full config
---

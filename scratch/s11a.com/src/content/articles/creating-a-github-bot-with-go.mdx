...
toc:
  - title: Goals
    items:
      - title: A quick note about Github Actions
  - title: Github App setup essentials
  - title: Authenticating
    items:
      - title: How to translate this to code
  - title: Responding to webhook events
  - title: Deploying and watching the automation 👀
  - title: Summary
---

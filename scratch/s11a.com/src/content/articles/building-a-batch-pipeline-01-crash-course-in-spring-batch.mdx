...
excerpt: >-
  The last post took look at a Spring Batch project template to get off the
...
toc:
  - title: Prerequisites
  - title: Goals
  - title: Intro to batch processing
  - title: Understanding Spring Batch... enough to get started
    items:
      - title: The Job interface
      - title: The Step interface
        items:
          - title: Chunky steps?
          - title: Tasklet steps
      - title: The ItemReader interface
      - title: the ItemProcessor interface
      - title: The ItemWriter interface
  - title: Summary
---

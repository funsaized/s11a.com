...
toc:
  - title: "TL;DR: ~~Cloudfront~~ + ~~S3~~ + Route53 -> Netlify DNS"
  - title: Getting on Netlify
  - title: Route53 -> Netlify DNS
    items:
      - title: Adding the domain to Netlify
      - title: Update the Route53 hosted zone (NS, SOA)
  - title: Adding the custom domain to my site
---
